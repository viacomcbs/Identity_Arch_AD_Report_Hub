...
try {
    ...
    $Users = Get-ADUser -LDAPFilter $LdapFilter -Server "${ForestRoot}:3268" -Properties extensionAttribute6, employeeID, employeeNumber, Title, Department, Description, whenCreated, whenChanged, Enabled, Manager @credParam
