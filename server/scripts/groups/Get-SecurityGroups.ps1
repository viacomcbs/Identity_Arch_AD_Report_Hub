...
try {
    ...
    $Groups = Get-ADGroup @ServerArgs -Filter { GroupCategory -eq "Security" } -Properties DisplayName, mail, Description, GroupScope, ManagedBy, WhenCreated, member @credParam
