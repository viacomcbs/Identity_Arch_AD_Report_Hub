...
try {
    ...
    $Groups = Get-ADGroup @ServerArgs -Filter { mail -like "*" } -Properties DisplayName, mail, Description, GroupCategory, GroupScope, ManagedBy, WhenCreated, member @credParam
